...
async fn main() -> Result<()> {
    ...
    task_system.register_function("fast_task", task_function!(|x: i32| async move {
    ...
    task_system.register_function("slow_task", task_function!(|x: i32| async move {
    ...
    task_system.register_function("infinite_task", task_function!(|| async move {
    ...
    for i in 0..100 {
        let name = if i % 2 == 0 { "infinite_task" } else { "slow_task" };
        let ref_ = if i % 2 == 0 {
