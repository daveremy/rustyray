...
mod tests {
    ...
    async fn test_task_timeout() {
        ...
        task_system.register_function("slow_task", task_function!(|delay_ms: u64| async move {
    ...
    async fn test_long_running_task_cancellation() {
        ...
        task_system.register_function("long_running", task_function!(|| async move {
    ...
    async fn test_no_timeout_for_fast_tasks() {
        ...
        for i in 0..20 {
            ...
            task_system.register_function(name, task_function!(|x: i32| async move {
